...
import { setCompletedCrop, setCrop, setIsOpen } from "../../model/store/image.store";
...
const ImageViewer = ({
  ...
  const { imgSrc, isOpen, crop, } = useSelector((state: RootState) => state.imageViewer)
  const { imgRef, onCropComplete } = useImageAttachment(setValue, setError, clearError);
